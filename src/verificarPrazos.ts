...
interface VerificarPrazosParams {
  parametro: string;
  filtro?: string;
}

async function verificarPrazos(params: VerificarPrazosParams): Promise<void> {
  try {
    ...
    console.log(`Executando verificarPrazos com parametro=${params.parametro}...`);
    ...
    const resultado = {
      ...
      status: "sucesso",
      mensagem: "Identifica prazos em documentos concluído com sucesso",
      resultado: {
